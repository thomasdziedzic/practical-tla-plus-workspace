...
Valid ==
    /\ \E ll \in AllLinkedLists:
        Assert(Cyclic(ll), <<"There should be some LL with a cycle", AllLinkedLists>>)
    /\ \E ll \in AllLinkedLists:
        Assert(~Cyclic(ll), <<"There should be some LL without a cycle", AllLinkedLists>>)
    /\ \A ll \in AllLinkedLists:
        Assert(CycleImpliesRingOrTwoParents(ll), <<"CounterExample", ll>>)
=============================================================================
\* Modification History
\* Last modified Thu Sep 19 19:27:40 CDT 2019 by tom
