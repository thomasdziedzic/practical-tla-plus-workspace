...
\*  at most one node with two parents (in the case of a cycle), and no nodes with more than two parents.
...
\*CountParents(ll, node) == Cardinality({p \in DOMAIN ll: ll[p] = node})
...
\* Last modified Fri Sep 20 07:59:04 CDT 2019 by tom
