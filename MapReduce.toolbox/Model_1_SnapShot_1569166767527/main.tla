...
begin
    ...
    ReduceResult:
        while \E w \in Workers: ~consumed[w] do
            ...
            or
                \* Reassign
                with from_worker \in {w \in UnfairWorkers: ~consumed[w] /\ result[w].count /= Len(assignments[w])}, to_worker \in FairWorkers do
...
\* Last modified Sun Sep 22 10:26:29 CDT 2019 by tom
